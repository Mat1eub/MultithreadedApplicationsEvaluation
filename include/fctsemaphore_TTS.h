...
/**
 * @struct Semaphore
 * @brief Represents a semaphore with a counter and a lock.
 * 
 * This structure is used to manage access to shared resources.
 * - `n`: Semaphore count indicating the availability of resources.
 * - `verou`: Lock variable for mutual exclusion.
 */
typedef struct {
...
/**
 * @brief Acquires a test-and-test-and-set lock.
 * 
...
/**
 * @brief Releases a test-and-test-and-set lock.
 * 
